  ...
  function renderComms(){
    ...
    const radioButton=state.elfUnlocked
      ? `<button class="mission-setting-toggle radio-setting ${state.elfAudioOn?'on':'off'}" id="elfAudioToggle" data-elf-audio aria-pressed="${state.elfAudioOn?'true':'false'}" aria-label="Radio ${state.elfAudioOn?'on':'off'}" ${streamReady?'':'aria-disabled="true"'}><span class="mission-setting-icon"><img src="./assets/radio-setting-icon.svg" alt=""></span><span class="mission-setting-copy"><span>Radio</span></span></button>`
      : `<button class="mission-setting-toggle radio-setting off tune" data-tune-elf aria-pressed="false" aria-label="Tune radio"><span class="mission-setting-icon"><img src="./assets/radio-setting-icon.svg" alt=""></span><span class="mission-setting-copy"><span>Radio</span><strong>Tune</strong></span></button>`;
    const settings=`<section class="mission-settings panel"><div class="mission-settings-head"><div class="kicker">Mission Settings</div></div><div class="mission-settings-grid"><button class="mission-setting-toggle ${gpsOn?'on':'off'}" data-gps-setting aria-pressed="${gpsOn?'true':'false'}" aria-label="GPS Location ${gpsOn?'on':'off'}"><span class="mission-setting-icon"><img src="./assets/radar-setup-icon.svg" alt=""></span><span class="mission-setting-copy"><span>GPS Location</span></span></button><button class="mission-setting-toggle ${state.audio?'on':'off'}" data-mission-audio-setting aria-pressed="${state.audio?'true':'false'}" aria-label="Mission Audio ${state.audio?'on':'off'}"><span class="mission-setting-icon"><img src="./assets/mission-audio-icon.webp" alt=""></span><span class="mission-setting-copy"><span>Mission Audio</span></span></button>${radioButton}</div></section>`;
