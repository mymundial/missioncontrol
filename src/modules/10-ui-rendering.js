  ...
  function navSleighIcon(){
    return `<span class="nav-sleigh-icon-wrap" aria-hidden="true"><svg class="nav-sleigh-svg" viewBox="0 0 64 28" aria-hidden="true"><path d="M14 18h26.5c4.8 0 8.9 2.2 11.4 6"/><path d="M9 22.5h40.5c3.1 0 5.9-.9 8.3-2.7"/><path d="M16.5 17.9 22 9.8h12.4c4.5 0 8.1 3.6 8.1 8.1"/><path d="M33.6 9.8 40 6.6"/><path d="M21.7 22.5 18.8 18"/></svg></span>`;
  }
  function navIcon(id){
    const icons={
