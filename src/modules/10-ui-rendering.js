  ...
  function renderComms(){
    ...
    const radioButton=state.elfUnlocked
      ? `<button class="mission-setting-toggle ${state.elfAudioOn?'on':'off'}" id="elfAudioToggle" data-elf-audio aria-pressed="${state.elfAudioOn?'true':'false'}" ${streamReady?'':'aria-disabled="true"'}><span class="mission-setting-icon"><img src="./assets/radio-setting-icon.svg" alt=""></span><span class="mission-setting-copy"><span>Radio</span><strong>${state.elfAudioOn?'On':'Off'}</strong></span></button>`
      : `<button class="mission-setting-toggle off tune" data-tune-elf aria-pressed="false"><span class="mission-setting-icon"><img src="./assets/radio-setting-icon.svg" alt=""></span><span class="mission-setting-copy"><span>Radio</span><strong>Tune</strong></span></button>`;
    ...
    const radio=state.elfUnlocked
      ? `<section class="comms-radio panel tuned compact"><div class="comms-radio-head"><div><div class="kicker">ELF FM</div><h2>87.7</h2></div></div><div class="wave locked ${state.elfAudioOn?'live':''}">${'<i></i>'.repeat(28)}</div><div class="radio-state-line ${state.elfAudioOn?'':'muted'}">${state.elfAudioOn?'Playing':'Radio Off'}</div></section>`
      : `<section class="comms-radio panel locked compact"><div class="comms-radio-head"><div><div class="kicker">ELF FM</div><h2>87.7</h2></div></div><div class="wave">${'<i></i>'.repeat(28)}</div><div class="radio-state-line muted">Signal Available</div></section>`;
