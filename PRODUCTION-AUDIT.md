...
PASS  CSS brace balance — 3156 rule blocks balanced
...
PASS  MC02 diagnostic redesign — MC02 now uses tap-to-scan copy, selective green capture states, a larger Stability console, tyre-only Traction capture, cyan Power bars, and stronger completion copy.
